"""
Training CLI for the wafer defect classifier. Run directly, or launched
automatically by app.py as a background subprocess on each new verified label.

    python train.py [--epochs 30] [--limit N] [--data data/LSWMD.pkl]

Always writes a new *candidate* under models/, never models/production.json --
promoting a candidate is a separate, manual action in the app's Model tab.
"""
